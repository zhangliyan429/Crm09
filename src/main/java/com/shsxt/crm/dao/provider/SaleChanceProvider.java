...
public class SaleChanceProvider {
    ...
    private static final String COLUMNS="t.id, t.customer_id,t.customer_name, t.overview, t.link_man, t.link_phone, t.create_man, "
            + " t.create_date, t.assign_man,t.assign_time,t.state,t.cgjl,t.description,t.chance_source";
