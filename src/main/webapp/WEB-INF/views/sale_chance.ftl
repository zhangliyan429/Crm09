...
<#--工具栏-->
    <div id="tb">
        ...
        <a href="javascript:deleteSaleChance()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a><br>
        </div>
        <div>
...
<#--弹出框-->
    <div id="dlg" class="easyui-dialog" style="width:700px;height:450px;padding: 10px 20px"
        ...
        <#--title="保存客户信息" style="width:500px;height:300px;"
         iconCls='icon-add' resizable=true modal=true closed=true button="#bt">-->
           ...
           <#-- <td>客户名称:</td>
            ...
            概要:<input id="overview" type="text" name="overview" /><br>
            创建人:<input id="createMan" type="text" name="createMan" /><br>
            状态:  <select id="state"  class="easyui-combobox" panelHeight="auto" editable="false" panelHeight="auto" >
            <option value="">请选择...</option>
            <option value="0">未分配</option>
            <option value="1">已分配</option>
        </select><br>-->
